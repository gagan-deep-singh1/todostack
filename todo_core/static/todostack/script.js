$(document).ready(function () {
    ...
    function refreshData() {
        ...
        //             dates.push(new Date(response[i].fields['created_at']));
        //         }
        ...
        //             var completed_at = response[i].fields['completed_at'];
        //
        //             //console.log('Id: ' + task_id + ' Name: ' + title);
		...
		// 				id="`+ task_id + `"></td>
		// 		<td colspan="2">
		// 			<h4 class="text-left" id="title'+ task_id +'">` + title + `</h4>
		// 		</td>
        ...
        //             <td>
        //                 <h4 class="text-left completed_tasks" id="title`+ task_id + `">` + title + `</h4>
        //             </td>
            ...
            $.ajax(
                {
                    ...
                    success: function () //This will get the data returned by the /add_new_task end point in JSON Format.
                    {
